...
//         e.preventDefault();
//         if (number > -1 && number < 100 && betAmount > 99) {
...
//             const response = await axios.post("/games/doubleDigitLottery/bets", {
//                 userID: userID,
...
//             }
//         } else {
//             alert('Select any number from 0 to 99. \nMinimum Bet Amount = 100.');
//         }
//     }
...
//                     try {
//                         const gamesResponse = await axios.get('/games/doubleDigitLottery/games');
//                         const gamesData = gamesResponse.data;
//                         setGameHistoryTable(gamesData);
//                         // Fetch bets data
//                         const betsResponse = await axios.get(`/games/doubleDigitLottery/bets/${userID}`);
...
//             <div className="text-2xl md:text-4xl font-bold text-center mt-28 mb-8 text-white underline underline-offset-8 italic">Double Digit Lottery</div>
...
//                         <div className='border-4 border-white text-xl rounded-md'>Enter a Number from 0 to 99</div>
//                         <div className='grid grid-cols-2 justify-center text-xl items-center border-2 border-black m-4 p-2'>
//                             Your Selection
//                             <input type="number" value={number} onChange={(e) => setNumber(e.target.value)} maxLength={2} min={0} max={99} className='p-2 border-4 font-bold outline-none shadow-md shadow-white text-black text-center w-1/2 h-auto rounded-lg bg-green-600 ml-2' name="doubleDigitNumber" id="doubleDigitNumber" />
//                         </div>
//                     </div>
...
//                         </div>
//                     </div>
//                     <div onClick={handleSubmitBet} className={`bg-blue-500 m-10 w-1/2 p-2 rounded-lg h-auto flex flex-col mx-auto hover:scale-125 border-4 hover:bg-blue-500 ${betCount < 1 ? '' : 'hidden'}`}>
//                         Place Bet
//                     </div>
//                     <div onClick={handleSubmitBet} className={`bg-blue-500 m-10 w-1/2 p-2 rounded-lg h-auto flex flex-col mx-auto hover:scale-125 border-4 hover:bg-blue-500 ${betCount >= 1 ? '' : 'hidden'}`}>
//                         Place More Bet
...
//                 </div>
//             </div>
//             <div className="text-center font-semibold bg-black text-white border-4 rounded-xl text-lg md:text-xl p-4 my-4 flex flex-row">Results</div>
...
//                             <th className="text-center border-4 p-1">Results</th>
//                         </tr>
//                     </thead>
