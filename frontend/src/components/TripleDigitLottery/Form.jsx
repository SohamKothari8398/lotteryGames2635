        ...
        <div className="px-4 pb-10 flex flex-col items-center">
            ...
            <div className=' items-center mb-10 border-4 py-2 grid grid-cols-1 w-auto lg:w-[50%] h-auto text-center rounded-xl text-white font-bold shadow-red-600 shadow-lg'>
                        ...
                        <div className='text-white flex flex-col w-full shadow-lg shadow-red-600 rounded-lg'>
                            ...
                            <div className='w-auto'>
                                <input type="number" value={number}
                                    ...
                                    className='p-2 m-2 w-11/12 text-center mx-auto font-semibold rounded-lg bg-red-600 text-black shadow-md shadow-white'
                                    name="tripleDigitNumber" id="tripleDigitNumber" />
                            </div>
                        </div>
                        <div className='text-white flex flex-col w-full shadow-lg shadow-red-600 rounded-lg'>
                            ...
                            <select
                                ...
                                className='p-2 m-2 text-center font-semibold rounded-lg bg-green-600 text-black shadow-md shadow-white'>
                        ...
                        <div className='text-white flex flex-col w-full shadow-lg shadow-red-600 rounded-lg'>
                            ...
                            <div className='w-auto'>
                                <input type='number' onChange={(e) => setBetAmount(parseInt(e.target.value, 10))}
                                    ...
                                    className='p-2 m-2 w-11/12 text-center mx-auto font-semibold rounded-lg bg-blue-600 text-black shadow-md shadow-white' />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-black mx-2 p-1 rounded-lg w-auto h-auto flex flex-col">
                    ...
                    {showRules ? (
                        <div>
                            <div className='border-white text-sm rounded-md'>1. Select a Number from 0 to 999</div>
