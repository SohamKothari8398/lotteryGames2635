...
const AdminUserRecordTable = () => {
    const service = useService();
    const [tableData, setTableData] = useState([]);
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await service.get('/admin/allUserRecords');
    ...
    return (
        <div className="bg-slate-600 flex flex-col w-full mb-2 items-center h-auto">
            ...
            <div className="text-center font-semibold text-white bg-black rounded-lg text-md md:text-xl lg:text-2xl p-4 my-4">Users Record</div>
...
export default AdminUserRecordTable;
